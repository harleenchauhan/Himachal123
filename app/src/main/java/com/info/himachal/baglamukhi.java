...
public class baglamukhi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baglamukhi);
       ...
       textView2=(TextView) findViewById(R.id.textView2);
        ...
        templename.put("Dal Lake","The Nagani Mata Temple, lo");
        templename.put("Kareri","The Nagani Mata Temple, lo");
        templename.put("Maharanapratap Sagar","The Nagani Mata Temple, lo");
        templename.put("Bir and Billing","The Nagani Mata Temple, lo");
        templename.put("Kangra Fort","The Nagani Mata Temple, lo");
        templename.put("MaharanaRanjeet sagar sanctuary","The Nagani Mata Temple, lo");
        templename.put("McleodGanj City","The Nagani Mata Temple, lo");
        templename.put("Triund Track","The Nagani Mata Temple, lo");
        templename.put("PlampurTea Garden","The Nagani Mata Temple, lo");
        templename.put("Gopalpur Zoo","The Nagani Mata Temple, lo");
        templename.put("Indrapasstrek","The Nagani Mata Temple, lo");



        Intent   il = getIntent();
        String s = il.getStringExtra("S");
        ...
        switch (s)
        {
            ...
            case "Indrapasstrek":
                ...
                imageView5.setImageResource(R.drawable.indrapasstrek1);
                break;
            case "PlampurTea Garden":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.palampurteagarden);
                break;
            case "Gopalpur Zoo":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.gopalpurzoo);
                break;
            case "Triund Track":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.triund1);
                break;
            case "McleodGanj City":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.mc);
                break;
            case "MaharanaRanjeet sagar sanctuary":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.maharanapratapsagarsanctuary);
                break;
            case "Kangra Fort":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.kangrafort);
                break;
            case "Bir and Billing":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.birandbilling);
                break;
            case "Kareri":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.kararilake);
                break;
            case "Maharanapratap Sagar":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.maharanapratapsagar1);
                break;

            case "Dal Lake":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.dallake1);
                break;

            case "BAGLAMUKHI TEMPLE":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.baglamukhi1);
                break;

           case "JWALAMUKHI TEMPLE":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.jwalaji);
                break;//
            case "BRIJESHWARI TEMPLE":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.kangra);
                break;
            case "BAIJNATH TEMPLE":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.baijnathtemple);
                break;
            case "CHAMUNDA DEVI":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.chamundakangara1);
                break;
            case "MASROOR TEMPLE":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.masroortemple1);
                break;
            case "BHAGSUNAG TEMPLE":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.bhagsutemple);
                break;
            case "KUNAL PATHRI":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.kunalpathri);
                break;
            case "NAGNI TEMPLE":
                textView2.setText(s2);
                imageView5.setImageResource(R.drawable.nagani);
                break;
        }
    }
